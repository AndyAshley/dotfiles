...
Pane {
    ...
    Item {
        ...
        GaussianBlur {
            ...
            radius: 0
            samples: config.BlurRadius * 1.5 + 1
            cached: true
            visible: config.FullBlur == "true" || config.PartialBlur == "true"
            ...
            Connections {
                target: form.passwordField
                onActiveFocusChanged: {
                    blurAnim.stop();
                    blurAnim.from = backgroundBlur.radius;
                    blurAnim.to = form.passwordField.activeFocus ? config.BlurRadius : 0;
                    blurAnim.start();
                }
            }
